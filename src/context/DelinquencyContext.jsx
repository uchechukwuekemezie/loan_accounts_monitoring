...
const DelinquencyContext = createContext();

export const useDelinquencyContext = () => useContext(DelinquencyContext);

export const DelinquencyProvider = ({ children }) => {
  ...
  return (
    <DelinquencyContext.Provider value={{ delinquencies, setDelinquencies }}>
      {children}
    </DelinquencyContext.Provider>
  );
};
